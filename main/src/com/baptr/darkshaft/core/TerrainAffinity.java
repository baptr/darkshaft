    ...
    try {
      ...
      for (String unitName : cfg.keys()) {
        ...
        try {
            ...
            try {
              ...
              Gdx.app.error(
                  ...
                  "Unrecognized TileType "
                      + "in TerrainAffinity config file "
                      + file
                      + ": "
                      + tileName);
            }
          ...
          Gdx.app.error(
              Darkshaft.LOG,
              "Unrecognized UnitType in "
                  + "TerrainAffinity config file "
                  + file
                  + ": "
                  + unitName);
        }
      ...
      throw new GdxRuntimeException("Malformed TerrainAffinity config in " + file);
    }
  }
