...
public class MapUtils {
    ...
    for (TiledObjectGroup group : map.objectGroups) {
      ...
      for (TiledObject object : group.objects) {
        ...
        if ("Spawn".equals(object.type)) {
          ...
          spawners[spawnNum].setLocation(object.x / object.width, object.y / object.height);
          ...
          spawners[endNum].setEnd(object.x / object.width, object.y / object.height);
        }
      }
    }
  ...
  /**
   * Find the {@link TileType} for a given tile ID. Will return TileType.BASIC if not specified in
   * the map.
   */
