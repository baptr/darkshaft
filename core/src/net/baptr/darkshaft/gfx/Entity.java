...
public class Entity extends Sprite implements Comparable<Entity> {
  ...
  protected Map<String, Animation<TextureRegion>> animations; // TODO EnumMap would be nice
  ...
  public Entity(float x, float y, String... regionNames) {
    ...
    for (String region : regionNames) {
      ...
      Animation<TextureRegion> an = new Animation<TextureRegion>(frameDuration, tr);
      an.setPlayMode(PlayMode.LOOP_PINGPONG);
